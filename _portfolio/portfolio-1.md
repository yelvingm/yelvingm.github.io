...
excerpt: "Co-Lead: Company Sponsored Project in a Student-Led Laboratory <br/><img src='/images/amigo.jpg' alt='AMIGO' width=350px height=auto/>"
...
<video controls playsinline preload="metadata" width=100px height=auto class="project-video" loop>
	<source src="{{ '/files/GPS_Test_outdoor.mp4' | relative_url }}" type="video/mp4">
	Your browser does not support the video tag. <a href="{{ '/files/GPS_Test_outdoor.mp4' | relative_url }}">Download the video</a>.
</video>
